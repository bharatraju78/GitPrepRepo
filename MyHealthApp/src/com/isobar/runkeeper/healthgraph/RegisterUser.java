...
public class RegisterUser extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			OAuthClientRequest oRequest = OAuthClientRequest.authorizationLocation(GraphConstants.AUTH_URL)
					.setClientId(GraphConstants.CLIENT_ID).setResponseType(RESPONSE_TYPE).setRedirectURI(GraphConstants.REDIRECT_URI)
					.buildQueryMessage();
